...
export const msalConfig = {
  auth: {
    ...
    redirectUri: process.env.REACT_APP_REDIRECT_URI || 'https://wb-aidw-chatbot-01.azurewebsites.net',
    postLogoutRedirectUri: process.env.REACT_APP_REDIRECT_URI || 'https://wb-aidw-chatbot-01.azurewebsites.net',
